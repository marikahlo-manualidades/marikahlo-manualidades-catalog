export const quadrosRotina = {
  valor: "Valor: R$200,00",
  descricao: [
    ...
    "Prazo de entrega de no mínimo 30 dias."
  ],
  imagens: [
    {
    ...
    {
      imagem: require("~/assets/image/produtos/quadros-rotina/quadro-rotina02.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/quadros-rotina/quadro-rotina03.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/quadros-rotina/quadro-rotina04.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/quadros-rotina/quadro-rotina05.jpg")
    },
    {
