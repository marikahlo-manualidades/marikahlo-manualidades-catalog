export const calendarios = {
  valor: "Valor: R$160,00",
  descricao: [
    "Os calendários podem ser temáticos. Criamos e confeccionamos a partir da escolha do cliente.",
    "Contém 31 dias, 12 meses, 03 anos, estações do ano tempo e humor + saquinho para guardar meses e anos.",
  ...
  imagens: [
    ...
    {
      imagem: require("~/assets/image/produtos/calendarios/calendario02.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/calendarios/calendario03.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/calendarios/calendario04.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/calendarios/calendario05.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/calendarios/calendario06.jpg")
    },
    {
      imagem: require("~/assets/image/produtos/calendarios/calendario07.jpg")
    },
    {
    ...
    {
      imagem: require("~/assets/image/produtos/calendarios/calendario16.jpg")
    },
    {
